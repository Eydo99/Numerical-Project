...
lse = Blueprint("lse", __name__)

@lse.route('/solve/gaussjordan', methods = ['POST'])
...
@lse.route('/solve/gausselim', methods = ['POST'])
...
@lse.route('/solve/cholesky', methods = ['POST'])
def handle_cholesky():
    # getting the needed values
    data = request.json
    dim : int = int(data.get("dim"))
...
@lse.route('/solve/crout', methods = ['POST'])
def handle_crout():
    # getting the needed values
    data = request.json
    dim : int = int(data.get("dim"))
...
@lse.route('/solve/dolittle', methods = ['POST'])
def handle_dolittle():
    # getting the needed values
    data = request.json
    dim : int = int(data.get("dim")) 
...
@lse.route('/solve/jacobi', methods = ['POST'])
def handle_jacobi():
    # getting the needed values
    data = request.json
    dim : int = int(data.get("dim")) 
...
@lse.route('/solve/gauss_seidel', methods = ['POST'])
